...
This document provides guidelines for internationalization of the Graincoin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `graincoin_en.ts` remains unchanged.
