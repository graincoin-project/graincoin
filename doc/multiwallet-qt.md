...
In order to support loading of multiple wallets in graincoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is graincoin.cpp.

Finally, two new headers and source files will have to be added to graincoin-qt.pro.
...
Changes to graincoin.cpp
----------------------
graincoin.cpp is the entry point into graincoin-qt, and as such, will require some minor modifications to provide hooks for
