...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    CNetAddr source = CNetAddr("252.2.2.2:11054");
    ...
    CService addr1 = CService("250.1.1.1:11054");
    addrman.Add(CAddress(addr1), source);
    BOOST_CHECK(addrman.size() == 1);
    CAddrInfo addr_ret1 = addrman.Select();
    BOOST_CHECK(addr_ret1.ToString() == "250.1.1.1:11054");

    // Test 3: Does IP address deduplication work correctly. 
    //  Expected dup IP should not be added.
    CService addr1_dup = CService("250.1.1.1:11054");
    ...
    //  have two addrs.
    CService addr2 = CService("250.1.1.2:11054");
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    CService addr1_port = CService("250.1.1.1:11055");
    addrman.Add(CAddress(addr1_port), source);
    BOOST_CHECK(addrman.size() == 1);
    CAddrInfo addr_ret2 = addrman.Select();
    BOOST_CHECK(addr_ret2.ToString() == "250.1.1.1:11054");
    ...
    BOOST_CHECK(addr_ret3.ToString() == "250.1.1.1:11054");
}
