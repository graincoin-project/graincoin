...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Graincoin graincoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  graincoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded graincoin transaction") + "\n" +
              "  graincoin-tx [options] -create [commands]   " + _("Create hex-encoded graincoin transaction") + "\n" +
              "\n";
